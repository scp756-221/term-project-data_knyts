...
start: showcontext
	$(EKS) create cluster --name $(CLUSTER_NAME) --version $(KVER) --region $(REGION) --nodegroup-name $(NGROUP) --node-type $(NTYPE) --nodes 5 --nodes-min 4 --nodes-max 10 --managed | tee $(LOG_DIR)/eks-start.log
